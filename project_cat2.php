...
<?php include "tpl/menu.php"; ?>
        <div id="main">
           ...
           <h1 class="main_title top"><?php echo $result['cur_term']['name']; ?></h1>
            ...
            <!-- #####   home_news  #####  -->
            <div id="project_archives" class="raw5" >
                ...
                <div class="single_project_2">
                    <a href="project.php?po=<?php echo $elm['id']; ?>" style="background-image:url(<?php echo $elm['img']; ?>)">
                        <img src="<?php echo $elm['img']; ?>" />
                        <div class="desc">
                            <h3><?php echo $elm['title']; ?></h3>
                        </div>
                    </a>
                </div>
                <?php } ?>
